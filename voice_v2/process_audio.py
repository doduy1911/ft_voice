...
# --- CẤU HÌNH ---
INPUT_FOLDER = "data_ytb/nu1"      # Folder chứa voice gốc của client
OUTPUT_FOLDER = "clean_dataset_nu" # Folder chứa kết quả
TEMP_FOLDER = "temp_denoised_nu"   # Folder trung gian
