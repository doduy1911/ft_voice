...
# --- CẤU HÌNH ---
INPUT_FOLDER = "/kaggle/working/ft_voice/voice_v2/data-ytb/nam1"      # Folder chứa voice gốc của client
OUTPUT_FOLDER = "/kaggle/working/ft_voice/voice_v2/clean_dataset_nam_v2" # Folder chứa kết quả
TEMP_FOLDER = "/kaggle/working/ft_voice/voice_v2/temp_denoised_nam_v2"   # Folder trung gian
